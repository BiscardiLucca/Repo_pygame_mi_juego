...
class FormGameLevel1(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.music_path = r"recursos/sounds/music/soundtrack_level_1.mp3"
        ...
        self.text_score = Label(master=self,x=1200,y=30,w=200,h=50,color_background=None,color_border=None,image_background=None,text=f"PUNTOS: {str(self.player_1.score)}",font="Bauhaus 93",font_size=30,font_color=C_WHITE)
        
        self.text_time = Label(master=self,x=1200,y=80,w=200,h=50,color_background=None,color_border=None,image_background=None,text=f"TIEMPO: {str(self.cronometro)}",font="Bauhaus 93",font_size=30,font_color=C_WHITE)
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=w,height=h,path="recursos/images/locations/hangar/hangar.png")
    ...
    def generate_player(self):
        player = Player(x=100, y=600, speed_walk=15, speed_run=15, gravity=15, jump_power=20, frame_rate_ms=100, move_rate_ms=45, jump_height=160, p_scale=1.7, interval_time_jump=300)
        return player

    def generate_enemies(self):
        self.enemies_list.append(Enemy(x=40, y= 175, speed_walk=5, speed_run=8, gravity=8, jump_power=30, frame_rate_ms=80, move_rate_ms=80, jump_height=140, p_scale=1.7, interval_time_jump=300, enemy_type=0, x_length=15))
        self.enemies_list.append(Enemy(x=1380, y=220, speed_walk=5, speed_run=8, gravity=8, jump_power=30, frame_rate_ms=80, move_rate_ms=80, jump_height=140, p_scale=1.7, interval_time_jump=300, enemy_type=0, x_length=15))
        self.enemies_list.append(Enemy(x=1100, y=620, speed_walk=9, speed_run=8, gravity=8, jump_power=30, frame_rate_ms=80, move_rate_ms=80, jump_height=140, p_scale=1.7, interval_time_jump=300, enemy_type=0, x_length=200))
        
    def generate_platform(self):
        self.platform_list.append(Plataform(x=10, y=260, height=50, width=200, image="recursos/images/tiles/level_1.png", column=0))
        self.platform_list.append(Plataform(x=250, y=390, height=50, width=50, image="recursos/images/tiles/level_1.png", column=0))
        self.platform_list.append(Plataform(x=400, y=540, height=50, width=200, image="recursos/images/tiles/level_1.png", column=0))
        self.platform_list.append(Plataform(x=685, y=390, height=50, width=50, image="recursos/images/tiles/level_1.png", column=0))
        self.platform_list.append(Plataform(x=900, y=390, height=50, width=200, image="recursos/images/tiles/level_1.png", column=0))
        self.platform_list.append(Plataform(x=1250, y=310, height=50, width=200, image="recursos/images/tiles/level_1.png", column=0))

    def generate_trampas(self):
        self.trampa_list.append(Trampa(x=480,y=525))
        self.trampa_list.append(Trampa(x=970,y=378))
    ...
    def update(self,lista_eventos,keys,delta_ms,event,evento_1000ms):
        ...
        if self.pausado:
            ...
            pausa_texto = self.font.render("JUEGO PAUSADO", True, (255, 255, 255))
