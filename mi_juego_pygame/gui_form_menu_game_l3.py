...
from greivous import Boss
from auxiliar import Auxiliar
from trampa import Trampa

class FormGameLevel3(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active,lvl2):
        super().__init__(name,master_surface,x,y,w,h,color_background,color_border,active)

        self.player_1 = self.generate_player()
        self.music_path = r"recursos/sounds/music/soundtrack_level_3.mp3"
        ...
        self.text_score = Label(master=self,x=1200,y=30,w=200,h=50,color_background=None,color_border=None,image_background=None,text=f'SCORE: {str(self.player_1.score)}',font="Bauhaus 93",font_size=30,font_color=C_WHITE)
        
        self.text_time = Label(master=self,x=1200,y=80,w=200,h=50,color_background=None,color_border=None,image_background=None,text=f'TIME: {str(self.cronometro)}',font="Bauhaus 93",font_size=30,font_color=C_WHITE)
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=w,height=h,path="recursos/images/locations/bodyguard/bodyguard.png")
    ...
    def generate_player(self):
        player = Player(x=1000, y=600, speed_walk=15, speed_run=15, gravity=15, jump_power=20, frame_rate_ms=100, move_rate_ms=45, jump_height=160, p_scale=1.7, interval_time_jump=300)
        return player

    def generate_enemies(self):
        self.enemies_list.append(Enemy(x=650, y=160, speed_walk=4, speed_run=8, gravity=8, jump_power=30, frame_rate_ms=80, move_rate_ms=80, jump_height=140, p_scale=1.7, interval_time_jump=300, enemy_type=0, x_length=50))
        self.enemies_list.append(Enemy(x=1250, y=160, speed_walk=4, speed_run=8, gravity=8, jump_power=30, frame_rate_ms=80, move_rate_ms=80, jump_height=140, p_scale=1.4, interval_time_jump=300, enemy_type=1, x_length=50))
        self.enemies_list.append(Enemy(x=650, y=460, speed_walk=4, speed_run=8, gravity=8, jump_power=30, frame_rate_ms=80, move_rate_ms=80, jump_height=140, p_scale=1.7, interval_time_jump=300, enemy_type=2, x_length=50))
        self.enemies_list.append(Enemy(x=1250, y=460, speed_walk=4, speed_run=8, gravity=8, jump_power=30, frame_rate_ms=80, move_rate_ms=80, jump_height=140, p_scale=1.7, interval_time_jump=300, enemy_type=2, x_length=50))
        self.enemies_list.append(Enemy(x=300, y=600, speed_walk=4, speed_run=8, gravity=8, jump_power=30, frame_rate_ms=80, move_rate_ms=80, jump_height=140, p_scale=1.7, interval_time_jump=300, enemy_type=1, x_length=100))

    def generate_platform(self):
        self.platform_list.append(Plataform(x=1200,y=540,height=50,width=200,image="recursos/images/tiles/level_3.png",column=0))
        self.platform_list.append(Plataform(x=900,y=540,height=50,width=200,image="recursos/images/tiles/level_3.png",column=0))
        self.platform_list.append(Plataform(x=600,y=540,height=50,width=200,image="recursos/images/tiles/level_3.png",column=0))
        self.platform_list.append(Plataform(x=1100,y=390,height=50,width=100,image="recursos/images/tiles/level_3.png",column=0))
        self.platform_list.append(Plataform(x=800,y=390,height=50,width=100,image="recursos/images/tiles/level_3.png",column=0))

        self.platform_list.append(Plataform(x=1200,y=240,height=50,width=200,image="recursos/images/tiles/level_3.png",column=0))
        self.platform_list.append(Plataform(x=900,y=240,height=50,width=200,image="recursos/images/tiles/level_3.png",column=0))
        self.platform_list.append(Plataform(x=600,y=240,height=50,width=200,image="recursos/images/tiles/level_3.png",column=0))

    def generate_boss(self):
        boss = Boss(x=20, y=550, frame_rate_ms=100, move_rate_ms=100)
        return boss

    def generate_trampas(self):
        self.trampa_list.append(Trampa(x=1135,y=700))
        self.trampa_list.append(Trampa(x=835,y=700))
